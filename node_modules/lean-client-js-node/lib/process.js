...
class ProcessTransport {
    constructor(executablePath, workingDirectory, options) {
        this.executablePath = executablePath || 'lean';
        this.workingDirectory = workingDirectory;
        this.options = options;
    }
    connect() {
        const process = child.spawn(this.executablePath, ['--server'].concat(this.options).concat([`*${this.workingDirectory}*`]), { cwd: this.workingDirectory, env: this.getEnv() });
